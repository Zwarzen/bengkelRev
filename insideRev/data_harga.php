    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!---add data---->
          <div class="btn">
          <a class="btn btn-primary" href="script/tambahDataHarga.php" > Tambah Data
          </a>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Info Harga</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include 'script/data_harga/koneksi.php';
                  ...
                  foreach ($data as $row) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href='script/data_harga/ubah.php?id_harga=$row[id_harga]'><i class = 'fa fa-cog'></i></a>
                        |
                        <a href='script/data_harga/delete.php?id_harga=$row[id_harga]'><i class = 'fa fa-trash-alt'></i></a>
