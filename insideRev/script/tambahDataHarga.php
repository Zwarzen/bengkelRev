<?php
  include 'data_harga/koneksi.php';
?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tambah Data Harga</h1>
        ...
        <div style="padding-bottom: 210px;">
            ...
            <fieldset style = "padding: 10px;">
			    ...
			    <table>
					...
					<form action = "data_harga/simpan.php" method = "post">
			            <fieldset style = "padding: 10px;">
			              
			              <div>
			                <label for = "nama_paket">Nama Paket</label>
			                  <input class = "form-control" type = "text" name = "nama_paket" id = "" required="true">
			              </div>
			              
			              <div>
			                <label for = "harga">Harga</label>
			                  <input class = "form-control" type = "text" name = "harga" id = "" required="true">
			              </div>

                    <div>
                      <label for = "keterangan">Keterangan</label>
                        <input class = "form-control" type = "text" name = "keterangan" id = "" required="true">
                    </div>
