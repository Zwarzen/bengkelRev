<?php
  include 'data_pegawai/koneksi.php';
?>
        ...
        <div style="padding-bottom: 210px;">
            ...
            <fieldset style = "padding: 10px;">
			    ...
			    <table>
					...
					<form action = "data_pegawai/simpan.php" method = "post">
			            <fieldset style = "padding: 10px;">
			              
			              <div>
			                <label for = "nama_pegawai">Nama pegawai</label>
			                  <input class = "form-control" type = "text" name = "nama_pegawai" id = "" required="true">
			              </div>
			              
			              <div>
			                <label for = "aktifitas">Aktifitas</label>
			                  <input class = "form-control" type = "text" name = "aktifitas" id = "" required="true">
			              </div>
