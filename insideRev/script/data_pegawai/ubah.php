<?php
  ...
  $pegawai=mysqli_query($koneksi, "SELECT * FROM tb_pegawai WHERE id_pegawai = '$id_pegawai'");
            ...
            <fieldset style = "padding: 10px;">
              ...
              <form method="post" action="action_update.php" style="padding: 10px;">
                ...
                <table>
                  ...
                  <tr>
                    <td>Nama Pegawai</td>
                    <td><input type="text" name="nama_pegawai" value="<?php echo $row['nama_pegawai']; ?>"></td>
                  </tr>

                  <tr>
                    <td>aktifitas</td>
                    <td><input type="text" name="aktifitas" value="<?php echo $row['aktifitas']; ?>"></td>
                  </tr>
                </table>
                ...
                <div class="buton" style="padding-top: 10px;">
                  ...
                  <a href="../../data_pegawai.php">KEMBALI</a>
                  </td>
                </div>
